...
![Banker UI in-game — green number is the banked amount, bottom text is inventory](https://i.imgur.com/KlarEFR.png)
...
![Assigning a Banker profile to an NPC](https://i.imgur.com/dQriWbn.png)
