...
![Assigning a Transmog profile to an NPC](../images/screenshots/JwHAUpQ.png)
...
![Transmog UI in-game](../images/screenshots/Fq4kjch.png)
...
![Picking an item and previewing a skin with a custom color](../images/screenshots/RZoeGwD.png)

Clicking the skin's add button spends the cost item and applies the transmog immediately:

![Transmog applied, with a recolor](../images/screenshots/uE9erX1.png)
...
![Using a non-equipment item as a skin, with ignore category on](../images/screenshots/T8QmpJm.png)

![The result — the weapon now looks like the trophy](../images/screenshots/Sd4Xsdo.png)
...
|---|---|
| ![Choosing an item](../images/screenshots/SDJsDOh.png) | ![Choosing a skin](../images/screenshots/DSkdimb.png) |

| Confirmed | Result on the item |
|---|---|
| ![Applied](../images/screenshots/STsZbGs.png) | ![New appearance](../images/screenshots/T4Ss9IB.png) |
...
![Equipped with the new appearance](../images/screenshots/apOXM30.png)
...
- [Profiles](../concepts/profiles.md) — how a transmogrification profile name groups skins across files.
...
- [Migrations](../reference/migrations.md) — an older visual-effects field that used to exist on this page's config format was removed in version 9.0.8.
