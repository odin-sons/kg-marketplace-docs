...
![Teleporter destination pins on the map](../images/screenshots/Hoy6Gg1.png)
...
- [Profiles](../concepts/profiles.md) — how a teleporter profile name groups destinations across files.
